...
namespace WebExercise.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public AdminPagesController(DbMarketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDecs,MetaKey,Alias,CreateAt,Ordering")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PageId,PageName,Contents,Thumb,Published,Title,MetaDecs,MetaKey,Alias,CreateAt,Ordering")] Page page)
        {
            if (id != page.PageId)
            {
                return NotFound();
